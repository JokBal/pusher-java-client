...
/**
 * Subscriptions to {@link com.pusher.client.channel.PrivateChannel Private} and {@link com.pusher.client.channel.PresenceChannel presence} channels
 * need to be authorized. This interface provides an {@link #authorize} as a mechanism for doing this.
 * 
 * <p>See the {@link com.pusher.client.util.HttpAuthorizer HttpAuthorizer} as an example.</p>
 */
